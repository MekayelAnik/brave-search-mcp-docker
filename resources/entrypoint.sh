...
readonly HAPROXY_SERVER_NAME="brave"
...
start_mcp_server() {
    local mcp_server_cmd="npx -y @brave/brave-search-mcp-server"
    ...
    echo "Launching Brave Search MCP with protocol: ${PROTOCOL_DISPLAY}"
