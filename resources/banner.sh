...
print_ascii_art() {
    ...
    printf "${NAVY_BLUE}   /SSSSSSS                                                /SSSSSS                                          /SS          ${NC} \n"
    printf "${NAVY_BLUE}  | SS__  SS                                              /SS__  SS                                        | SS          ${NC} \n"
    printf "${NAVY_BLUE}  | SS  \ SS  /SSSSSS  /SSSSSS  /SS    /SS /SSSSSS       | SS  \__/  /SSSSSS   /SSSSSS   /SSSSSS   /SSSSSSS| SSSSSSS     ${NC} \n"
    printf "${NAVY_BLUE}  | SSSSSSS  /SS__  SS|____  SS|  SS  /SS//SS__  SS      |  SSSSSS  /SS__  SS |____  SS /SS__  SS /SS_____/| SS__  SS    ${NC} \n"
    printf "${NAVY_BLUE}  | SS__  SS| SS  \__/ /SSSSSSS \  SS/SS/| SSSSSSSS       \____  SS| SSSSSSSS  /SSSSSSS| SS  \__/| SS      | SS  \ SS    ${NC} \n"
    printf "${NAVY_BLUE}  | SS  \ SS| SS      /SS__  SS  \  SSS/ | SS_____/       /SS  \ SS| SS_____/ /SS__  SS| SS      | SS      | SS  | SS    ${NC} \n"
    printf "${NAVY_BLUE}  | SSSSSSS/| SS     |  SSSSSSS   \  S/  |  SSSSSSS      |  SSSSSS/|  SSSSSSS|  SSSSSSS| SS      |  SSSSSSS| SS  | SS    ${NC} \n"
    printf "${NAVY_BLUE}  |_______/ |__/      \_______/    \_/    \_______/       \______/  \_______/ \_______/|__/       \_______/|__/  |__/    ${NC} \n"
